...
<head>
  ...
  <!--Links to fontawesome CSS, and custom CSS files-->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" />
  <link rel="stylesheet" href="../Styles/PageStyles.css">
  <!--Links to JQuery and Bootstrap CSS-->
...
<body>
  ...
  <div class="popularProduct">
    <!-- <h1 class="popTxt h-auto d-flex justify-content-lg-start justify-content-sm-center mx-lg-5 mx-sm-0">Snacks</h1> -->
    ...
    <div class="container-fluid items-container ms-auto">
      <div class="snacks-container row productRow align-content-center justify-content-center">


      </div>
      <h1 class="popTxt h-auto d-flex justify-content-lg-start justify-content-sm-center mx-lg-5 mx-sm-0">Beverages</h1>
      <div class="beverages-container row productRow align-content-center justify-content-center">


      </div>
      <h1 class="popTxt h-auto d-flex justify-content-lg-start justify-content-sm-center mx-lg-5 mx-sm-0">Cereals</h1>
      <div class="cereals-container row productRow align-content-center justify-content-center">
