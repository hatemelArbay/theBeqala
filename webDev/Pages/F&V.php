...
<?php include '../includes/category.php'; ?>
  ...
  <div class="popularProduct">
    <h1 class="popTxt h-auto d-flex justify-content-lg-start justify-content-sm-center mx-lg-5 mx-sm-0">Fruits and Vegetables</h1>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="form-group">
            ...
            <select id="sort" class="form-control">
              ...
              <option value="name" class="choice">Name (A-Z)</option>
              <option value="date" class="choice">Newly Added</option>
            </select>
          </div>
        </div>
    ...
    <div class="container-fluid items-container ms-auto">
      <div class="fruits-container row productRow align-content-center justify-content-center">


      </div>
      <div class="vegetables-container row productRow align-content-center justify-content-center">
