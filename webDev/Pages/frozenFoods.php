...
<body>
    ...
    <div class="popularProduct">
        ...
        <h1 class="popTxt h-auto d-flex justify-content-lg-start justify-content-sm-center mx-lg-5 mx-sm-0">Frozen Food</h1>
        <div class="container-fluid items-container ms-auto">
            <div class="row productRow align-content-center justify-content-center frozenFood-container">
            </div>
